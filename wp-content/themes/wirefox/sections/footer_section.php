<div id="footer-container">
    ...
    <div id="backtotop" class="button-wrap back_to_top">
        <div class="icon-wrap parallax-wrap">
            <div class="button-icon parallax-element">
                ...
                <!-- <i class="back_top fa-regular fa-7x fa-circle-up"></i> -->
            </div>
        </div>
        <!-- <div class="button-text sticky left"><span data-hover="Back Top">Back Top</span></div> -->
    </div>
    ...
    <!-- <div class="socials-wrap">
        ...
        <ul class="socials">
            <li><span class="parallax-wrap"><a class="parallax-element" href="https://www.dribbble.com/clapat" target="_blank">Db</a></span>
            </li>
            ...
            <li><span class="parallax-wrap"><a class="parallax-element" href="https://www.facebook.com/clapat.ro" target="_blank">Fb</a></span>
            </li>
