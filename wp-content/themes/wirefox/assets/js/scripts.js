...
---------------------------------------------------*/
  ...
  function LazyLoad() {
    ...
    setTimeout(function () {
      $("header").removeClass("white-header");
      $("body").removeClass(
        "load-project-thumb load-project-thumb-with-title load-next-page grid-open"
      );
      setTimeout(function () {
        imagesLoaded("body", function () {
  ...
  function ShowcaseCarousel() {
    if ($(".showcase-carousel").length > 0) {
      ...
      class Item {
        constructor(DOM_el) {
          ...
          if (this.DOM.image != null) {
            this.DOM.imageInner =
              this.DOM.image.querySelector(".section-image");
          }
        }
      }
      ...
      const hideGrid = () => {
        ...
        animateTitle.to(
          ".showcase-carousel .carousel-zoom-wrapper .slide-caption span",
          { duration: 0.5, y: -100, opacity: 0, ease: Power2.easeInOut }
        );
      ...
      const getDOMElements = () => {
        ...
        // Cloned items
        const itemsCloned = [];
        [...document.querySelectorAll(".clapat-slide-clone")].forEach(
          (item) => {
      ...
      const previewModeEnabled = document.querySelector(
      ...
      if (!isMobile()) {
        ...
        $(".showcase-carousel .clapat-slide .slide-inner").on(
          "mouseenter",
          function () {
      ...
      $(".trigger-item").on("click", function () {
        ...
        setTimeout(function () {
          ...
          var moveTitle =
            $(".temporary-hero .inner").outerHeight() -
            $(".temporary-hero .slide-title").outerHeight();
      ...
      if ($(".showcase-slider").hasClass("rotate-caption")) {
        ...
        for (let i = 0; i < arrTitles.length; i++) {
          ...
          if (i != 0) {
            ...
            slider.tl.fromTo(
              rowTitleWrapper,
              { yPercent: 0, rotationX: 0, z: 0, opacity: 1 },
              {
                yPercent: -65,
                rotationX: 90,
                z: -60,
        ...
        slider.tl.fromTo(
          firstTitle,
          { yPercent: 65, rotationX: -90, z: -60, opacity: 0.5 },
          {
            yPercent: 0,
            rotationX: 0,
            z: 0,
      ...
      $(".trigger-item").on("click", function () {
        ...
        setTimeout(function () {
          ...
          clonedListItem
            ...
            .appendTo(".temporary-hero .inner");
          var moveTitle =
            $(".temporary-hero .inner").outerHeight() / 2 -
            $(".temporary-hero .slide-title").outerHeight() * 0.5 -
            1;
          gsap.to($(".temporary-hero .slide-title"), {
            duration: 1.5,
            y: moveTitle,
          ...
          init: function () {
            if ($("body").hasClass("show-loader")) {
              gsap.to(
                ...
                { duration: 0.5, opacity: 1, delay: 0.3, ease: Power2.easeOut }
              );
            }
          },
        },
        ...
        dragWrapper.on("mousedown", function (evt) {
          dragWrapper.on("mouseup mousemove", function handler(evt) {
            if (evt.type === "mouseup") {
              ...
              $(".showcase-lists .clapat-sync-slide .slide-inner").on(
                "click",
                function () {
                  if (!$("body").hasClass("scale-drag-y")) {
                    gsap.to($(".showcase-lists .slide-title span"), {
...
---------------------------------------------------*/
  ...
  function ShowcaseGallery() {
    if ($(".showcase-gallery").length > 0) {
          ...
          if (document.body.classList.contains("grid-open")) {
            ...
            Flip.from(flipstate, {
              ...
              onComplete: function () {
                ...
                gsap.to(
                  ".showcase-gallery .gallery-zoom-wrapper a.slide-link",
                  {
                    duration: 0.3,
                    opacity: 1,
                    scale: 1,
      ...
      $(".slide-hero-title span, .slide-hero-subtitle span").wrap(
        "<div></div>"
      );
      ...
      if ($("#filters-wrapper").length > 0) {
        ...
        $("#footer-container").on(
          ...
          function () {
            ...
            $(".toggle-filters").text(
              filtersWrapper.hasClass("on") ? "Close" : "Filters"
            );
            ...
            var filtersHeight =
              ...
              filtersLi
                .toArray()
                .reduce((acc, li) => acc + $(li).outerHeight(true), 0);
