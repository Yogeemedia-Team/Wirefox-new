                    ...
                    ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="post_img">
                                        <img src="<?php echo $featured_image_url; ?>" alt="Image Title">
                                    </div>
                                </div>
                                <div class="col-lg-8 my-auto">
                                    <div class="w-75">
                                        <h5 class="mb-0"><a href="https://wirefox.co.uk/ecommerce-marketing-strategies-to-increase-sales/" class="link"><?php the_title(); ?></a></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
